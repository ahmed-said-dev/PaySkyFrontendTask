...
@Component({
  ...
  styleUrls: ['../../../../assets/scss/pages/admin-dashboard/add-update-product-dialog/add-update-product-dialog.component.scss'],
})
export class AddUpdateProductDialogComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AddUpdateProductDialogComponent>,
